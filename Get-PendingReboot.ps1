<#
    .SYNOPSIS
        This script returns the pending reboot state of the local system

    .DESCRIPTION
        This script returns the pending reboot state of the local system by checking several registry settings

        for details see the post from Adam Bertram at https://adamtheautomator.com/pending-reboot-registry/
